...
impl ErrorMsg {
    pub fn new<S: Into<String>>(error: S, seq: i64) -> GameMessage {
        GameMessage {
            msg_seq: seq,
            sender_id: None,
            receiver_id: None,
...
impl AnnouncementMsg {
    pub fn new(games: Vec<GameAnnouncement>, seq: i64) -> GameMessage {
        GameMessage {
            msg_seq: seq,
            sender_id: None,
            receiver_id: None,
            r#type: Some(Type::Announcement(AnnouncementMsg { games })),
        }
    }
}
